...
public class measurement {
	public static void main(String[] args) throws IOException {
		BufferedReader br = new BufferedReader(new FileReader(new File("measurementSilver.in")));
		PrintWriter pw = new PrintWriter(new FileWriter(new File("measurementSilver.out")));
