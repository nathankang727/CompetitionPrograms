...
public class wormsort {
	...
	public static void main(String[] args) throws IOException {
		BufferedReader br = new BufferedReader(new FileReader(new File("wormsort.in")));
		PrintWriter pw = new PrintWriter(new FileWriter(new File("wormsort.out")));
		...
		pw.println(minW <= 1000000000 ? minW : "-1");
		br.close();
		pw.close();
	}
